 ...
 * @description: 一句话描述功能;
 * @author: 周海涛
 * @date: 2018/7/26 22:52
 * @comment: 备注
 * @version: V1.0
 */
@Component
@Validated
//@PropertySource(value = "classpath:application.properties")author.properties
@PropertySource(value = "classpath:application.properties")
@ConfigurationProperties(prefix = "mongo")
public class MongoSettingsProperties {
    @NotBlank
    private String database;
    private @NotEmpty List<String> address;
    ...
    private Integer serverSelectionTimeout = 40000;
